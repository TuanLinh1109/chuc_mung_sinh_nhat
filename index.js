const contentLetterSrart_actived = "💘Chúc mừng sinh nhật Bé Phương của anh 💘" //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc bé Phương của anh một ngày sinh nhật tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với em trong hôm nay và cả những ngày sau💘." //Nội dung của bức thư
...
imgLetter.src = "./img/bephuong.jpg"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
